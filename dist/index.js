...
export default defineChannelPluginEntry({
    ...
    description: "WhatsApp channel through the EVO platform (Evolution API): the controller forwards EVO events to this plugin, which answers customer messages with the agent and replies via EVO.",
