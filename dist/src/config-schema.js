...
export const wabaEvoPluginConfigSchema = buildJsonChannelConfigSchema({ ...EVO_CHANNEL_CONFIG_JSON_SCHEMA, properties: { ...EVO_CHANNEL_CONFIG_JSON_SCHEMA.properties } }, { uiHints: { ...evoChannelConfigUiHints } });
